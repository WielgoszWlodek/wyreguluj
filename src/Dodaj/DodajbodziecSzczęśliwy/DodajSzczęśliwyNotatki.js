...
export default function DodajSzczęśliwyNotatki() {
    ...
    <Qn2>Czy był to czynnik zewnętrzny(ktoś, coś) czy wewnętrzny(np. myśl)?</Qn2>
            <Controls>
              {({ back, destinations: { step464, step474} }) => (
                ...
                <Buttons>
                  <button className="button-580" onClick={step464}  role="button">Zewnętrzny</button>
              
                  <button className="button-580" onClick={step474} role="button">Wewnętrzny</button>
                  </Buttons>
                  <Buttons>
            ...
            <Controls>
              {({ back, destinations: { step441, step451} }) => (
                <>
                  ...
                  <button className="button-580" onClick={step441} role="button">Bezwartościowy</button>
                  <button className="button-580" onClick={step451} role="button">Nieistotny</button>
            ...
            <Controls>
              {({ back, destinations: { step444, step445} }) => (
                <>
                  ...
                  <button className="button-580" onClick={step444} role="button">Wyobcowany</button>
                  <button className="button-580" onClick={step445} role="button">Niepasujący</button>
