...
import SłabySenny from "../pages/uczucia/słaby/SłabySenny";
import SłabyRozkojarzony from "../pages/uczucia/słaby/SłabyRozkojarzony";
import SłabyObojętny from "../pages/uczucia/słaby/SłabyObojętny";
import SłabyApatyczny from "../pages/uczucia/słaby/SłabyApatyczny"
import SłabyPospieszany from "../pages/uczucia/słaby/SłabyPospieszany";
import SłabyPodpresją from "../pages/uczucia/słaby/SłabyPodpresją";
import SłabyTracącyKontrolę from "../pages/uczucia/słaby/SłabyTracącyKontrolę";
import SłabyPrzytłoczony from "../pages/uczucia/słaby/SłabyPrzytłoczony";
import SłabyNiewiem from "../pages/uczucia/słaby/SłabyNiewiem"; 


import ZaskoczonyWstrząśnięty from "../pages/uczucia/zaskoczony/ZaskoczonyWstrząśnięty";
import ZaskoczonySkonsternowany from "../pages/uczucia/zaskoczony/ZaskoczonySkonsternowany";
import ZaskoczonyEnergiczny from "../pages/uczucia/zaskoczony/ZaskoczonyEnergiczny";
import ZaskoczonyOchoczy from "../pages/uczucia/zaskoczony/ZaskoczonyOchoczy";
import ZaskoczonyZakłopotany from "../pages/uczucia/zaskoczony/ZaskoczonyZakłopotany";
import ZaskoczonyRozczarowany from "../pages/uczucia/zaskoczony/ZaskoczonyRozczarowany";
import ZaskoczonyZatrwożony from "../pages/uczucia/zaskoczony/ZaskoczonyZatrwożony";
import ZaskoczonyZdziwiony from "../pages/uczucia/zaskoczony/ZaskoczonyZdziwiony";
import ZaskoczonyNiewiem from "../pages/uczucia/zaskoczony/ZaskoczonyNiewiem";

import ZniesmaczonyNiechętny from "../pages/uczucia/zniesmaczony/ZniesmaczonyNiechętny";
import ZniesmaczonyKrytykancki from "../pages/uczucia/zniesmaczony/ZniesmaczonyKrytykancki";
import  ZniesmaczonyZbuntowany from "../pages/uczucia/zniesmaczony/ZniesmaczonyZbuntowany";
import  ZniesmaczonyAntypatyczny from "../pages/uczucia/zniesmaczony/ZniesmaczonyAntypatyczny";
import  ZniesmaczonyPodburzony from "../pages/uczucia/zniesmaczony/ZniesmaczonyPodburzony";
import  ZniesmaczonyObrzydzony from "../pages/uczucia/zniesmaczony/ZniesmaczonyObrzydzony";
import  ZniesmaczonyCzującyOdrazę from "../pages/uczucia/zniesmaczony/ZniesmaczonyCzującyOdrazę";
import  ZniesmaczonyNiepewny from "../pages/uczucia/zniesmaczony/ZniesmaczonyNiepewny";
import ZniesmaczonyNiewiem from "../pages/uczucia/zniesmaczony/ZniesmaczonyNiewiem";

import LękliwyBezsilny from "../pages/uczucia/lękliwy/LękliwyBezsilny";
import LękliwyZastraszony from "../pages/uczucia/lękliwy/LękliwyZastraszony";
import LękliwyPrzytłoczony from "../pages/uczucia/lękliwy/LękliwyPrzytłoczony";
import LękliwyZmartwiony from "../pages/uczucia/lękliwy/LękliwyZmartwiony";
import LękliwyZdemaskowany from "../pages/uczucia/lękliwy/LękliwyZdemaskowany";
import LękliwyWyobcowany from "../pages/uczucia/lękliwy/LękliwyWyobcowany";
import LękliwyPodrzędny from "../pages/uczucia/lękliwy/LękliwyPodrzędny";
import LękliwyNiewystarczający from "../pages/uczucia/lękliwy/LękliwyNiewystarczający";
import LękliwyNiepasujący from "../pages/uczucia/lękliwy/LękliwyNiepasujący";
import LękliwyBezwartościowy from "../pages/uczucia/lękliwy/LękliwyBezwartościowy";
import LękliwyNerwowy from "../pages/uczucia/lękliwy/LękliwyNerwowy";
import LękliwyNieistotny from "../pages/uczucia/lękliwy/LękliwyNieistotny";
import LękliwyNiewiem from "../pages/uczucia/lękliwy/LękliwyNiewiem";

import SmutnyBezsilny from "../pages/uczucia/smutny/SmutnyBezsilny";
import SmutnyGorszyodinnych from "../pages/uczucia/smutny/SmutnyGorszyodinnych";
import SmutnyOdizolowany from "../pages/uczucia/smutny/SmutnyOdizolowany";
import SmutnyPorzucony from "../pages/uczucia/smutny/SmutnyPorzucony";
import SmutnyPrześladowany from "../pages/uczucia/smutny/SmutnyPrześladowany";
import SmutnyRozczarowany from "../pages/uczucia/smutny/SmutnyRozczarowany";
import SmutnySkruszony from "../pages/uczucia/smutny/SmutnySkruszony";
import SmutnySłabowity from "../pages/uczucia/smutny/SmutnySłabowity";
import SmutnyWbólu from "../pages/uczucia/smutny/SmutnyWbólu";
import SmutnyWyczerpany from "../pages/uczucia/smutny/SmutnyWyczerpany";
import SmutnyZawstydzony from "../pages/uczucia/smutny/SmutnyZawstydzony";
import SmutnyZlekceważony from "../pages/uczucia/smutny/SmutnyZlekceważony";
import SmutnyNiewiem from "../pages/uczucia/smutny/SmutnyNiewiem";

import SzczęśliwyZuchwały from "../pages/uczucia/szczęśliwy/SzczęśliwyZuchwały";
import SzczęśliwyPobudzony from "../pages/uczucia/szczęśliwy/SzczęśliwyPobudzony";
import SzczęśliwyWolny from "../pages/uczucia/szczęśliwy/SzczęśliwyWolny";
import SzczęśliwyWesoły from "../pages/uczucia/szczęśliwy/SzczęśliwyWesoły";
import SzczęśliwyZaciekawiony from "../pages/uczucia/szczęśliwy/SzczęśliwyZaciekawiony";
import SzczęśliwyDociekliwy from "../pages/uczucia/szczęśliwy/SzczęśliwyDociekliwy";
import SzczęśliwyWażny from "../pages/uczucia/szczęśliwy/SzczęśliwyWażny";
import SzczęśliwyPewnysiebie from "../pages/uczucia/szczęśliwy/SzczęśliwyPewnysiebie";
import SzczęśliwySzanowany from "../pages/uczucia/szczęśliwy/SzczęśliwySzanowany";
import SzczęśliwyDoceniony from "../pages/uczucia/szczęśliwy/SzczęśliwyDoceniony";
import SzczęśliwyOdważny from "../pages/uczucia/szczęśliwy/SzczęśliwyOdważny";
import SzczęśliwyKreatywny from "../pages/uczucia/szczęśliwy/SzczęśliwyKreatywny";
import SzczęśliwyKochający from "../pages/uczucia/szczęśliwy/SzczęśliwyKochający";
import SzczęśliwyWdzięczny from "../pages/uczucia/szczęśliwy/SzczęśliwyWdzięczny";
import SzczęśliwyCzuły from "../pages/uczucia/szczęśliwy/SzczęśliwyCzuły";
import SzczęśliwyFiglarny from "../pages/uczucia/szczęśliwy/SzczęśliwyFiglarny";
import SzczęśliwyPełennadziei from "../pages/uczucia/szczęśliwy/SzczęśliwyPełennadziei";
import SzczęśliwyZainspirowany from "../pages/uczucia/szczęśliwy/SzczęśliwyZainspirowany";
import SzczęśliwyNiewiem from "../pages/uczucia/szczęśliwy/SzczęśliwyNiewiem";

import RozgniewanyOburzony from "../pages/uczucia/rozgniewany/RozgniewanyOburzony";
import RozgniewanyOśmieszony from "../pages/uczucia/rozgniewany/RozgniewanyOśmieszony";
import RozgniewanyPodejrzliwy from "../pages/uczucia/rozgniewany/RozgniewanyPodejrzliwy";
import RozgniewanyPoirytowany from "../pages/uczucia/rozgniewany/RozgniewanyPoirytowany";
import RozgniewanySarkastyczny from "../pages/uczucia/rozgniewany/RozgniewanySarkastyczny";
import RozgniewanySceptyczny from "../pages/uczucia/rozgniewany/RozgniewanySceptyczny";
import RozgniewanySprowokowany from "../pages/uczucia/rozgniewany/RozgniewanySprowokowany";
import RozgniewanyUrażony from "../pages/uczucia/rozgniewany/RozgniewanyUrażony";
import RozgniewanyWrogonastawiony from "../pages/uczucia/rozgniewany/RozgniewanyWrogonastawiony";
import RozgniewanyZamkniętywsobie from "../pages/uczucia/rozgniewany/RozgniewanyZamkniętywsobie";
import RozgniewanyZazdrosny from "../pages/uczucia/rozgniewany/RozgniewanyZazdrosny";
import RozgniewanyZbeszczeszczony from "../pages/uczucia/rozgniewany/RozgniewanyZbeszczeszczony";
import RozgniewanyZdradzony from "../pages/uczucia/rozgniewany/RozgniewanyZdradzony";
import RozgniewanyZgorszony from "../pages/uczucia/rozgniewany/RozgniewanyZgorszony";
import RozgniewanyZlekceważony from "../pages/uczucia/rozgniewany/RozgniewanyZlekceważony";
import RozgniewanyNiepewny from "../pages/uczucia/rozgniewany/RozgniewanyNiepewny";
import RozgniewanyNiewiem from "../pages/uczucia/rozgniewany/RozgniewanyNiewiem";
...
{/*SŁABY WSZYSTKO*/}
    ...
    <div>
            ...
            <Controls>
              {({ back, destinations: { step12, step13, step14, step15, step1511} }) => (
                <>
                <button className="button-53" onClick={step12} role="button">Zmęczony</button>
                <button className="button-53" onClick={step13} role="button">Znudzony</button>
                <button className="button-53" onClick={step14} role="button">Zapracowany</button>
                <button className="button-531" onClick={step15} role="button">Zestresowany</button>
                <button className="button-53" onClick={step1511} role="button">Nie wiem</button>
            ...
            <Controls>
              {({ back, destinations: { step22, step23, step24, step25, step2511} }) => (
                <>
                   ...
                   <button className="button-59" onClick={step22} role="button">Przestraszony</button>
                   <button className="button-59" onClick={step23} role="button">Zmieszany</button>
                   <button className="button-59" onClick={step24} role="button">Zdumiony</button>
                     <button className="button-591" onClick={step25} role="button">Podekscytowany</button>
                     <button className="button-59" onClick={step2511} role="button">Nie wiem</button>
            ...
            <Controls>
              {({ back, destinations: { step32, step33, step34, step35, step3511} }) => (
                <>
                   ...
                   <button className="button-55" onClick={step32} role="button">Nieprzychylny</button>
                   <button className="button-55" onClick={step33} role="button">Rozczarowany</button>
                   <button className="button-55" onClick={step34} role="button">Czujący się podle</button>
                   <button className="button-551" onClick={step35} role="button">Stroniący</button>
                   <button className="button-55" onClick={step3511} role="button">Nie wiem</button>
            ...
            <Controls>
              {({ back, destinations: { step52, step53, step54, step55, step56, step57, step5711} }) => (
                <>
                    ...
                    <button className="button-57" onClick={step52} role="button">Samotny</button>
                    <button className="button-57" onClick={step53} role="button">Zraniony</button>
                    <button className="button-57" onClick={step54} role="button">Zrozpaczony</button>
                    <button className="button-57" onClick={step55} role="button">Winny</button>
                    <button className="button-571" onClick={step56} role="button">Przygnębiony</button>
                    <button className="button-57" onClick={step57} role="button">Zraniony</button>
                    <button className="button-57" onClick={step5711} role="button">Nie wiem</button>
 ...
 {/*output słaby, znudzony, apatyczny, obojętny */}
    ...
    <Qn1>A tak dokładniej?</Qn1>
            <Controls>
              {({ back, destinations: { step62, step63, step64, step65, step66, step67, step68, step69,step70, step6711} }) => (
                <>
              

                   <button className="button-581" onClick={step62} role="button">Żartobliwy</button>
                   <button className="button-581" onClick={step63} role="button">Zadowolony</button>
                   <button className="button-581" onClick={step64} role="button">Zainteresowany</button>
                   <button className="button-581" onClick={step65} role="button">Dumny</button>
                   <button className="button-581" onClick={step66} role="button">Akceptowany</button>
                   <button className="button-581" onClick={step67} role="button">Pełen siły</button>
                   <button className="button-5811" onClick={step68} role="button">Spokojny</button>
                   <button className="button-581" onClick={step69} role="button">Czujący bliskość</button>
                   <button className="button-581" onClick={step70} role="button">Optymistyczny</button>
                   <button className="button-581" onClick={step6711} role="button">Nie wiem</button>
 ...
 {/*output słaby, znudzony, apatyczny, obojętny */}
    ...
    <Qn1>A tak dokładniej?</Qn1>
            <Controls>
              {({ back, destinations: { step72, step73, step74, step75, step76, step77, step78, step79, step7711} }) => (
                <>
               

                  
                   <button className="button-541" onClick={step72} role="button">Rozczarowany</button>
                   <button className="button-541" onClick={step73} role="button">Upokożony</button>
                   <button className="button-541" onClick={step74} role="button">Nienawistny</button>
                   <button className="button-541" onClick={step75} role="button">Zagrożony</button>
                   <button className="button-541" onClick={step76} role="button">Agresywny</button>
                   <button className="button-5411" onClick={step77} role="button">Sfrustrowany</button>
                   <button className="button-541" onClick={step78} role="button">Zdystansowany</button>
                   <button className="button-541" onClick={step79} role="button">Krytyczny</button>
                   <button className="button-541" onClick={step7711} role="button">Nie wiem</button>
