...
import { Grid, Image,  Form , TextArea, Header,Table } from 'semantic-ui-react';
...
<Container> 
 ...
 <Header style={{ marginTop:-70, textFont:15, marginLeft:40}}>
...
{ post1.filter(osoba => osoba._id === path).map(filteredPerson => (
            ...
            {filteredPerson.title === "Szczęśliwy"  && <> 
                ...
                <div className='butony'>
                    ...
                    <button  className="button-298" onClick={step2} role="button">Wzmocnić</button>
                    <button className="button-299"  onClick={step3} role="button">Osłabić</button>
                   </div> 
     ...
     {filteredPerson.title === "Smutny"  && <> 
      ...
      <div className='butony'>
          <button  className="button-898" onClick={step2} role="button">Wzmocnić</button>
          <button className="button-899"  onClick={step3} role="button">Osłabić</button>
         </div> 
  ...
  {filteredPerson.title === "Rozgniewany"  && <> 
      ...
      <div className='butony'>
          ...
          <button  className="button-398" onClick={step2} role="button">Wzmocnić</button>
          <button className="button-399"  onClick={step3} role="button">Osłabić</button>
         </div> 
    ...
    <div className='butony'>
        ...
        <button  className="button-498" onClick={step2} role="button">Wzmocnić</button>
        <button className="button-499"  onClick={step3} role="button">Osłabić</button>
       </div> 
  ...
  <div className='butony'>
      ...
      <button  className="button-598" onClick={step2} role="button">Wzmocnić</button>
      <button className="button-599"  onClick={step3} role="button">Osłabić</button>
     </div> 
...
<div className='butony'>
    ...
    <button  className="button-798" onClick={step2} role="button">Wzmocnić</button>
    <button className="button-799"  onClick={step3} role="button">Osłabić</button>
   </div> 
...
<div className='butony'>
    ...
    <button  className="button-698" onClick={step2} role="button">Wzmocnić</button>
    <button className="button-699"  onClick={step3} role="button">Osłabić</button>
   </div> 
   
</> } 

    
   <FormBtn1><Link to={`/`} ><Links>Wróć</Links></Link></FormBtn1>
    </article>   
  ...
  {/*SŁABY WSZYSTKO*/}
      ...
      <Step name="step3">
      <div>
              <Qn1>Podaj natężenie uczucia</Qn1>
              <Controls>
