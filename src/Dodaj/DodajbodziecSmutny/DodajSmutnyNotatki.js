...
export default function DodajSmutnyNotatki() {
    ...
    <Qn2>Czy był to czynnik zewnętrzny(ktoś, coś) czy wewnętrzny(np. myśl)?</Qn2>
            <Controls>
              {({ back, destinations: { step464, step474} }) => (
                ...
                <Buttons>
                  <button className="button-57" onClick={step464}  role="button">Zewnętrzny</button>
              
                  <button className="button-57" onClick={step474} role="button">Wewnętrzny</button>
                  </Buttons>
                  <Buttons>
