...
import ZniesmaczonyNotatki from "../../pages/uczucia/zniesmaczony/ZniesmaczonyNotatki";
import ZniesmaczonyBodziec from "../../pages/uczucia/zniesmaczony/ZniesmaczonyBodziec";
import ZniesmaczonyBodziecwewnątrz from "../../pages/uczucia/zniesmaczony/ZniesmaczonyBodziecwewnątrz";
...
export default function DodajZniesmaczonyStan() {
                ...
                <McqContainer>
                    <Wizard tree={tree} first="step1">
                            ...
                            <div>
                                ...
                                <Controls>
                                    {({ back, destinations: { step2, step3, step4 } }) => ( 
                                        <>
                                            <Buttons>
                                                <button className="button-550" onClick={step2} role="button"> Minuty-Godziny</button>
                                                <button className="button-550" onClick={step3} role="button">Dni-Tygodnie</button>
                                                <button className="button-550" onClick={step4} role="button">Lata</button>
                                            </Buttons>
                                        </>
                                    )}
                                </Controls>
                                ...
                                <Controls>
                                    {({ back, destinations: { step5, step6 } }) => (
                                        <>
                                            ...
                                            <Buttons>
                                                <button className="button-550" onClick={step5} role="button">Tak</button>

                                                <button className="button-550" onClick={step6} role="button">Nie</button>
                                            </Buttons>
                                            <Buttons>
                                ...
                                <Controls>
                                    {({ back, destinations: { step14, step15 } }) => (
                                        <>
                                            ...
                                            <Buttons>
                                                <button className="button-550" onClick={step14} role="button">Tak</button>
                                                <button className="button-550" onClick={step15} role="button">Nie</button>
                                            </Buttons>
                                            <Buttons>
                                                <FormBtn onClick={back}>Wróć</FormBtn>
                                                {/*<FormBtn onClick={step4}>Next</FormBtn>*/}
                            ...
                            <div>
                                ...
                                <Controls>
                                    {({ back, destinations: { step18, step19 } }) => (
                                        <>
                                            <Buttons>
                                                <button className="button-550" onClick={step18} role="button">Tak</button>
                                                <button className="button-550" onClick={step19} role="button">Nie</button>
                                            </Buttons>
                                            <Buttons>
                                                <FormBtn onClick={back}>Wróć</FormBtn>
                                                {/*<FormBtn onClick={step4}>Next</FormBtn>*/}
                            ...
                            <div>
                                ...
                                <Controls>
                                    {({ back, destinations: { step7, step8 } }) => (
                                        <>
                                            <Buttons>
                                                <button className="button-550" onClick={step7} role="button">Zewnętrzny</button>

                                                <button className="button-550" onClick={step8} role="button">Wewnętrzny</button>
                                            </Buttons>
                                            <Buttons>
                                                <FormBtn onClick={back}>Wróć</FormBtn>
                                                {/*<FormBtn onClick={step4}>Next</FormBtn>*/}
                            ...
                            <div>
                                ...
                                <Controls>
                                    {({ back, destinations: { step5, step10 } }) => (
                                        <>
                                            <Buttons>
                                                <button className="button-550" onClick={step5} role="button">Już widzę</button>
                                                <button className="button-550" onClick={step10} role="button">Nie widzę</button>
                                            </Buttons>
                                            <Buttons>
                                                <FormBtn onClick={back}>Wróć</FormBtn>
                            ...
                            <div>
                                ...
                                <Controls>
                                    {({ back, destinations: { step11, step12 } }) => (
                                        <>
                                            <Buttons>
                                                <button className="button-550" onClick={step11} role="button">Tak</button>
                                                <button className="button-550" onClick={step12} role="button">Nie</button>
                                            </Buttons>
                                            <Buttons>
                                                <FormBtn onClick={back}>Wróć</FormBtn>
                                                {/*<FormBtn onClick={step4}>Next</FormBtn>*/}
                            ...
                            <div>
                                ...
                                <Controls>
                                    {({ back, destinations: { step3, step4 } }) => (
                                        <>
                                            <Buttons>
                                                <button className="button-550" onClick={step3} role="button">Dni-Tygodnie temu</button>
                                                <button className="button-550" onClick={step4} role="button">Lata temu</button>
                                            </Buttons>
                                            <Buttons>
                                                <FormBtn onClick={back}>Wróć</FormBtn>
                                                {/*<FormBtn onClick={step4}>Next</FormBtn>*/}
                            ...
                            <div>
                                ...
                                <Controls>
                                    {({ back, destinations: { step13 } }) => (
                                        <>
                                            <Buttons>
                                                <button className="button-55" onClick={step13} role="button">Dalej </button>
                        ...
                        <Step name="step13">
                            <div>
                                <Qn>
                                    ...
                                    <ZniesmaczonyNotatki czynnik="Nierozpoznany" cospowodowało="Nieznany" />
                                </Qn>
                                <br />
                                <Controls>
                                    {({ back, destinations: { } }) => (
                        ...
                        <Step name="step15">
                            <div>
                                <Qn>
                                    <ZniesmaczonyNotatki czynnik="Nastrój" cospowodowało="Nieznany" />
                                </Qn>
                                <br />
                                <Controls>
                                    {({ back, destinations: { } }) => (
                            ...
                            <div>
                                ...
                                <Controls>
                                    {({ back, destinations: { step20, step21 } }) => (
                                        <>
                                            <Buttons>
                                                <button className="button-550" onClick={step20} role="button">Zewnętrzny</button>

                                                <button className="button-550" onClick={step21} role="button">Wewnętrzny</button>
                                            </Buttons>
                                            <Buttons>
                                                <FormBtn onClick={back}>Wróć</FormBtn>
                                                {/*<FormBtn onClick={step4}>Next</FormBtn>*/}
                        ...
                        <Step name="step19">
                            <div>
                                <Qn>
                                    <ZniesmaczonyNotatki czynnik="Osobowość" cospowodowało="Nieznany" />
                                </Qn>
                                <br />
                                <Controls>
                                    {({ back, destinations: { } }) => (
                        ...
                        <Step name="step7">
                            <div>
                                <Qn>
                                    <ZniesmaczonyBodziec skąd="Emocja" />
                                </Qn>
                                <br />
                                <Controls>
                                    {({ back, destinations: { } }) => (
                        ...
                        <Step name="step8">
                            <div>
                                <Qn>
                                    <ZniesmaczonyBodziecwewnątrz skąd="Emocja" />
                                </Qn>
                                <br />
                                <Controls>
                                    {({ back, destinations: { } }) => (
                            ...
                            <div>
                                ...
                                <Controls>
                                    {({ back, destinations: { step16, step17 } }) => (
                                        <>
                                            <Buttons>
                                                <button className="button-550" onClick={step16} role="button">Zewnętrzny</button>
                                                <button className="button-550" onClick={step17} role="button">Wewnętrzny</button>
                                            </Buttons>
                                            <Buttons>
                                                <FormBtn onClick={back}>Wróć</FormBtn>
                                                {/*<FormBtn onClick={step4}>Next</FormBtn>*/}
                        ...
                        <Step name="step16">
                            <div>
                                <Qn>
                                    <ZniesmaczonyBodziec skąd="Nastrój" />
                                </Qn>
                                <br />
                                <Controls>
                                    {({ back, destinations: { } }) => (
                        ...
                        <Step name="step17">
                            <div>
                                <Qn>
                                    <ZniesmaczonyBodziecwewnątrz skąd="Nastrój" />
                                </Qn>
                                <br />
                                <Controls>
                                    {({ back, destinations: { } }) => (
                        ...
                        <Step name="step20">
                            <div>
                                <Qn>
                                    <ZniesmaczonyBodziec skąd="Osobowość" />
                                </Qn>
                                <br />
                                <Controls>
                                    {({ back, destinations: { } }) => (
                        ...
                        <Step name="step21">
                            <div>
                                <Qn>
                                    <ZniesmaczonyBodziecwewnątrz skąd="Osobowość" />
                                </Qn>
                                <br />
                                <Controls>
                                    {({ back, destinations: { } }) => (
                            ...
                            <div>
                                ...
                                <Controls>
                                    {({ back, destinations: { step461, step471 } }) => (
                                        <>
                                            <button className="button-550" onClick={step461} role="button">Minfuty-Godziny</button>
                                            <button className="button-550" onClick={step471} role="button">Dni-Tygodnie</button>
                                            <button className="button-550" onClick={step461} role="button">Tygodnie-Miesiące</button>
                                            <Buttons>
                                                <FormBtn onClick={back}>Wróć</FormBtn>
                                                {/*<FormBtn onClick={step4}>Next</FormBtn>*/}
                                            </Buttons>
                            ...
                            <div>
                                ...
                                <Controls>
                                    {({ back, destinations: { step481, step491 } }) => (
                                        <>
                                            <button className="button-550" onClick={step481} role="button">Niewystarczający</button>
                                            <button className="button-550" onClick={step491} role="button">Podrzędny</button>
                                            <Buttons>
                                                <FormBtn onClick={back}>Wróć</FormBtn>
                                                {/*<FormBtn onClick={step4}>Next</FormBtn>*/}
                                            </Buttons>
                                ...
                                <Controls>
                                    {({ back, destinations: { step441, step451 } }) => (
                                        <>
                                            ...
                                            <button className="button-55" onClick={step441} role="button">Bezwartościowy</button>
                                            <button className="button-55" onClick={step451} role="button">Nieistotny</button>
                                ...
                                <Controls>
                                    {({ back, destinations: { step444, step445 } }) => (
                                        <>
                                            ...
                                            <button className="button-55" onClick={step444} role="button">Wyobcowany</button>
                                            <button className="button-55" onClick={step445} role="button">Niepasujący</button>
                                ...
                                <Controls>
                                    {({ back, destinations: { step446, step447 } }) => (
                                        <>
                                            ...
                                            <button className="button-55" onClick={step446} role="button">Nerwowy</button>
                                            <button className="button-55" onClick={step447} role="button">Zdemaskowany</button>
                            ...
                            <div>
                                ...
                                <Controls>
                                    {({ back, destinations: { step42, step446 } }) => (
                                        <>
                                            <Buttons>
                                                <button className="button-550" onClick={step42} role="button">Już widzę</button>
                                                <button className="button-550" onClick={step446} role="button">Nie widzę</button>
                                            </Buttons>
                                            <Buttons>
                                                <FormBtn onClick={back}>Wróć</FormBtn>
