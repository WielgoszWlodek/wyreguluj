...
export default function DodajZniesmaczonyNotatki() {
{/*const [title, setTitle] = useState("Słaby");
  const [desc, setDesc] = useState("Zniesmaczony");
    ...
    <Qn2>Czy był to czynnik zewnętrzny(ktoś, coś) czy wewnętrzny(np. myśl)?</Qn2>
            <Controls>
              {({ back, destinations: { step464, step474} }) => (
                ...
                <Buttons>
                  <button className="button-550" onClick={step464}  role="button">Zewnętrzny</button>
              
                  <button className="button-550" onClick={step474} role="button">Wewnętrzny</button>
                  </Buttons>
                  <Buttons>
            ...
            <Controls>
              {({ back, destinations: { step461, step471} }) => (
                <>
                  ...
                  <button className="button-550" onClick={step461} role="button">Minuty-Godziny</button>
            ...
            <Controls>
              {({ back, destinations: { step441, step451} }) => (
                <>
                  ...
                  <button className="button-550" onClick={step441} role="button">Bezwartościowy</button>
                  <button className="button-550" onClick={step451} role="button">Nieistotny</button>
            ...
            <Controls>
              {({ back, destinations: { step444, step445} }) => (
                <>
                  ...
                  <button className="button-550" onClick={step444} role="button">Wyobcowany</button>
                  <button className="button-550" onClick={step445} role="button">Niepasujący</button>
            ...
            <Controls>
              {({ back, destinations: { step446, step447} }) => (
                <>
                  ...
                  <button className="button-550" onClick={step446} role="button">Nerwowy</button>
                  <button className="button-550" onClick={step447} role="button">Zdemaskowany</button>
