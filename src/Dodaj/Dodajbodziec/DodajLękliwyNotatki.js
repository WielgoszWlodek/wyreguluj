...
export default function DodajLękliwyNotatki() {
    ...
    <Qn2>Czy był to czynnik zewnętrzny(ktoś, coś) czy wewnętrzny(np. myśl)?</Qn2>
            <Controls>
              {({ back, destinations: { step464, step474} }) => (
                ...
                <Buttons>
                  <button className="button-560" onClick={step464}  role="button">Zewnętrzny</button>
              
                  <button className="button-560" onClick={step474} role="button">Wewnętrzny</button>
                  </Buttons>
                  <Buttons>
            ...
            <Controls>
              {({ back, destinations: { step481, step491} }) => (
                <>
                  ...
                  <button className="button-560" onClick={step481} role="button">Niewystarczający</button>
                  <button className="button-560" onClick={step491} role="button">Podrzędny</button>
            ...
            <Controls>
              {({ back, destinations: { step441, step451} }) => (
                <>
                  ...
                  <button className="button-560" onClick={step441} role="button">Bezwartościowy</button>
                  <button className="button-560" onClick={step451} role="button">Nieistotny</button>
