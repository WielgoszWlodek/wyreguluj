...
export default function DodajLękliwybodziec() {
...
<Container>
    ...
    <Step name="step1">
            ...
            <Qn2> Czy wiesz co spowodowało twoje uczucie?</Qn2>
      <br/>
       <Controls>
              {({ back, destinations: { step42, step43} }) => (
                <>
                <Buttons>
                    <button className="button-560" onClick={step42} role="button">Tak</button>
                    <button className="button-560" onClick={step43} role="button">Nie</button>
                    </Buttons>
                </>
              )}
            </Controls>
