...
import LękliwyBodziec from "../../pages/uczucia/lękliwy/lękliwyBodziec/LękliwyBodziec"
import LękliwyBodziecwewnątrz from "../../pages/uczucia/lękliwy/lękliwyBodziec/LękliwyBodziecwewnątrz"
...
export default function DodajLękliwyStan() {
      ...
      <div>
       ...
       <Controls>
              {({ back, destinations: { step2, step3, step4} }) => (
                <>
                <Buttons>
                    <button className="button-560" onClick={step2} role="button">Minuty-Godziny</button>
                    <button className="button-560" onClick={step3} role="button">Dni-Tygodnie</button>
                    <button className="button-560" onClick={step4} role="button">Lata</button>
                </Buttons>
                </>
              )}
            </Controls>
    ...
    <Qn2>Czy wiesz co spowodowało uczucie?</Qn2>
            <Controls>
              {({ back, destinations: { step5, step6} }) => (
                ...
                <Buttons>
                  <button className="button-560" onClick={step5}  role="button">Tak</button>
              
                  <button className="button-560" onClick={step6} role="button">Nie</button>
                  </Buttons>
                  <Buttons>
    ...
    <Qn2>Czy wiesz co spowodowało uczucie?</Qn2>
            <Controls>
              {({ back, destinations: { step14, step15} }) => (
                ...
                <Buttons>
                  <button className="button-560" onClick={step14}  role="button">Tak</button>
                  <button className="button-560" onClick={step15} role="button">Nie</button>
                  </Buttons>
                  <Buttons>
                    <FormBtn onClick={back}>Wróć</FormBtn>
                    {/*<FormBtn onClick={step4}>Next</FormBtn>*/}
...
<Step name="step4">
    ...
    <Qn2>Czy wiesz co spowodowało uczucie?</Qn2>
            <Controls>
              {({ back, destinations: { step18, step19} }) => (
                ...
                <Buttons>
                  <button className="button-560" onClick={step18}  role="button">Tak</button>
                  <button className="button-560" onClick={step19} role="button">Nie</button>
                  </Buttons>
                  <Buttons>
                    <FormBtn onClick={back}>Wróć</FormBtn>
                    {/*<FormBtn onClick={step4}>Next</FormBtn>*/}
    ...
    <Qn3>Czy był to czynnik zewnętrzny(ktoś, coś) czy wewnętrzny(np. myśl)?</Qn3>
            <Controls>
              {({ back, destinations: { step7, step8} }) => (
                ...
                <Buttons>
                  <button className="button-560" onClick={step7}  role="button">Zewnętrzny</button>
              
                  <button className="button-560" onClick={step8} role="button">Wewnętrzny</button>
                  </Buttons>
                  <Buttons>
                    <FormBtn onClick={back}>Wróć</FormBtn>
                    {/*<FormBtn onClick={step4}>Next</FormBtn>*/}
      ...
      <Qn3>
        ...
        <Controls>
              {({ back, destinations: {step5, step10 } }) => (
                <> 
                <Buttons>
                 <button className="button-560" onClick={step5} role="button">Już widzę</button>
                 <button className="button-560" onClick={step10} role="button">Nie widzę</button>
                 </Buttons>
                 <Buttons>
                    <FormBtn onClick={back}>Wróć</FormBtn>
      ...
      bodziec powstał wcześniej?</Qn3>
            <Controls>
              {({ back, destinations: { step11, step12} }) => (
                ...
                <Buttons>
                  <button className="button-560" onClick={step11}  role="button">Tak</button>
                  <button className="button-560" onClick={step12} role="button">Nie</button>
                </Buttons>
                  <Buttons>
                    <FormBtn onClick={back}>Wróć</FormBtn>
                    {/*<FormBtn onClick={step4}>Next</FormBtn>*/}
    ...
    <Qn2> Czy bodziec pojawił się?</Qn2>
            <Controls>
              {({ back, destinations: { step3, step4} }) => (
                ...
                <Buttons>
                <button className="button-560" onClick={step3} role="button">Dni-Tygodnie temu</button>
                    <button className="button-560" onClick={step4} role="button">Lata temu</button>
                </Buttons>
                  <Buttons>
                    <FormBtn onClick={back}>Wróć</FormBtn>
                    {/*<FormBtn onClick={step4}>Next</FormBtn>*/}
       ...
       - Nie chcesz pamiętać.</li>
            ...
            <Controls>
              {({ back, destinations: { step13} }) => (
                ...
                <Buttons>
                  <button className="button-56" onClick={step13}  role="button">Dalej </button>
    ...
    <Step name="step13">
      ...
      <LękliwyNotatki czynnik="Nierozpoznany" cospowodowało="Nieznany"/>
       </Qn>
        <br />
        <Controls>
              {({ back, destinations: { } }) => (
    ...
    <Step name="step15">
      ...
      <LękliwyNotatki czynnik="Nastrój" cospowodowało="Nieznany"/>
       </Qn>
        <br />
        <Controls>
              {({ back, destinations: { } }) => (
    ...
    <Qn3>Czy był to czynnik zewnętrzny(ktoś, coś) czy wewnętrzny(np. myśl)?</Qn3>
            <Controls>
              {({ back, destinations: { step20, step21} }) => (
                ...
                <Buttons>
                  <button className="button-560" onClick={step20}  role="button">Zewnętrzny</button>
              
                  <button className="button-560" onClick={step21} role="button">Wewnętrzny</button>
                  </Buttons>
                  <Buttons>
                    <FormBtn onClick={back}>Wróć</FormBtn>
                    {/*<FormBtn onClick={step4}>Next</FormBtn>*/}
 ...
 <Step name="step19">
      ...
      <LękliwyNotatki czynnik="Osobowość" cospowodowało="Nieznany"/>
       </Qn>
        <br />
        <Controls>
              {({ back, destinations: { } }) => (
    ...
    <Step name="step8">
      ...
      <LękliwyBodziecwewnątrz skąd = "Emocja" />
       </Qn>
        <br />
        <Controls>
              {({ back, destinations: { } }) => (
    ...
    <Qn3>Czy był to czynnik zewnętrzny(ktoś, coś) czy wewnętrzny(np. myśl)?</Qn3>
            <Controls>
              {({ back, destinations: { step16, step17} }) => (
                ...
                <Buttons>
                  <button className="button-560" onClick={step16}  role="button">Zewnętrzny</button>
              
                  <button className="button-560" onClick={step17} role="button">Wewnętrzny</button>
                  </Buttons>
                  <Buttons>
                    <FormBtn onClick={back}>Wróć</FormBtn>
                    {/*<FormBtn onClick={step4}>Next</FormBtn>*/}
    ...
    <Step name="step17">
      ...
      <LękliwyBodziecwewnątrz skąd = "Nastrój" />
       </Qn>
        <br />
        <Controls>
              {({ back, destinations: { } }) => (
    ...
    <Step name="step21">
      ...
      <LękliwyBodziecwewnątrz skąd = "Osobowość" />
       </Qn>
        <br />
        <Controls>
              {({ back, destinations: { } }) => (
            ...
            <Controls>
              {({ back, destinations: { step461, step471} }) => (
                <>
                  ...
                  <button className="button-560" onClick={step461} role="button">Minuty-Godziny</button>
                  <button className="button-560" onClick={step471} role="button">Dni-Tygodnie</button>
                  <button className="button-560" onClick={step461} role="button">Tygodnie-Miesiące</button>
      ...
      <Qn2>
        ...
        <Controls>
              {({ back, destinations: {step42, step446 } }) => (
                <> 
                <Buttons>
                 <button className="button-560" onClick={step42} role="button">Już widzę</button>
                 <button className="button-560" onClick={step446} role="button">Nie widzę</button>
                 </Buttons>
                 <Buttons>
                    <FormBtn onClick={back}>Wróć</FormBtn>
