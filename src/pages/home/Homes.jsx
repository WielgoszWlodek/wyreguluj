...
import { Icon, Button, Popup , Card, Image,  Container, TextArea  } from 'semantic-ui-react'
...
<Card.Header style={{marginBottom:"-14px", color:"#37454e"}}>
    Opis
  </Card.Header>
    </Card.Content>
    <Card.Content>
            ...
            <Card.Description>
              Nazwa uczucia: {desc? desc : "..."}
              </Card.Description>
                <Card.Description>
              Bodziec: {bodzce? bodzce : "..."}
              </Card.Description>
              <Card.Description>
              Stan: {stan? stan : "..."}
              </Card.Description>
              <Card.Description>
              Notatki: <Popup style={{ minWidth: '700px', minHeight:'300px' }}
               
               
    content= { <TextArea style={{ minWidth: '680px', minHeight:'280px' , border:'none'}} placeholder= {opis? opis : "..."}/>}
    
    trigger={  <Icon disabled name='edit' />}
  />
    ...
    <Card.Content>
    <Card.Header style={{marginBottom:"-5px", color:"#37454e"}}>
    Regulacja emocji:
  </Card.Header>
  </Card.Content>
              ...
              <Card.Description style={{ color:"grey", marginBottom:"13px"}}>
              Proponowane ćwiczenia: ...
              </Card.Description>  
             
              <Card.Content>
    <Card.Header style={{marginBottom:"-13px", color:"#37454e"}}>
     Natężenie po regulacji:
  </Card.Header>
  </Card.Content>
        <Card.Description>
...
{new Date(createdAt).toLocaleDateString()}
    ...
    <Card.Content extra>
        ...
        {title === "Lękliwy"  &&
  <>    
      <Button basic animated='vertical' color='blue'>
         <Link to={`/dodajLękliwy/${_id}`} className='btn1'>
         <Button.Content visible>Reguluj</Button.Content>
  ...
  <>    
      <Button basic animated='vertical' color='blue'>
         <Link to={`/dodajSłaby/${_id}`} className='btn1'>
         <Button.Content visible>Reguluj</Button.Content>
      <Button.Content hidden>
        <Icon name='arrow up' />
      </Button.Content>
...
{title === "Rozgniewany"  &&
  ...
  <>    
       <Button basic animated='vertical' color='blue'>
         <Link to={`/dodajSzczęśliwy/${_id}`} className='btn1'>
         <Button.Content visible>Reguluj</Button.Content>
      <Button.Content hidden>
        <Icon name='arrow up' />
      </Button.Content>
...
{title === "Zniesmaczony"  &&
  <>    
     <Button basic animated='vertical' color='blue'>
      ...
      <Link  onClick = {handleClick}><Button.Content visible>Zobacz</Button.Content>
      <Button.Content hidden>
