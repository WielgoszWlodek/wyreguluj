...
post.reverse();
 ...
 const onChange = (e, pageInfo) => {
    ...
    setApiUrl('/posts/?user='+user._id +'&skip='+(pageInfo.activePage.toString()-1)+'&limit=4');
  };
console.log(data1)
  ...
  return (
    ...
    <div className="loader"></div>
      ...
      <div className='container'>
          {searchInput.length > 1 ? (  filteredResults.slice(0).map((follower) => {
            return <Homes key={follower._id } {...follower} />
          })) :( post.slice(0).map((follower) => {
            return <Homes key={follower._id } {...follower} />
          })) }
...
{/*<div {post? className="paginacja" : className="paginacja1">
 <div
        className={
...
{post.length > 0  ?(
  ...
  <>
 <div className= "brakdanych">Brak danych</div>
  <div className="paginacja1">
