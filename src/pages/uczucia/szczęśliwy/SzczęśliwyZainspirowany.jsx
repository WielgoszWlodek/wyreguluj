...
export default function SzczęśliwyZainspirowany() {
  const [title, setTitle] = useState("Szczęśliwy");
  const [desc, setDesc] = useState("Optymistyczny/Zainspirowany");
   ...
   <Grid >
    ...
    <Grid.Row stretched>
      <Grid.Column>
          ...
          <br/>
          <Button className='button-581' size="large"   color='yellow'  role="button" loading={isLoading} disabled={isLoading1}  onClick={handleClick}>
