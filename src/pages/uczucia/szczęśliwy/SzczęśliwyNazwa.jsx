...
export default function SzczęśliwyNazwa(props) {
...
const buttonRef = createRef()
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      .then(() => {
        history.push("/DodajSzczęśliwyStan/"+path)
    ...
    <Grid.Row stretched>
      <Grid.Column>
          <Segment  color='red'  size='mini'>
           ...
           <Segment color='yellow' size='small'>
            <input
            type="text"
            value={desc}
          ...
          <Button animated className='button-580' size="large"   color='yellow'  role="button" loading={isLoading} disabled={isLoading1}  onClick={handleClick}>
           {isLoading ? "" : "" }
