...
export default function SzczęśliwyBodziec(props) {
    ...
    <Grid.Row stretched>
      ...
      Wybierz przyczynę uczucia
        ...
        Wpisz własną (i wciśni Enter)
          ...
          <br/>
          <Button className='button-580' size="large" style={{marginTop:"65px"}}   color='yellow'  role="button" loading={isLoading} disabled={isLoading1}  onClick={handleClick}>
