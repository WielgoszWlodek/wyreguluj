...
export default function Szczęśliwy() {
  ...
  const [ratingSzczesliwy, setRatingSzczesliwy] = useState(2);
...
const buttonRef = createRef()
  ...
  const settings = {
    ...
    max: 8,
    step: 1,
    onChange: ratingSzczesliwy => {
      setRatingSzczesliwy(ratingSzczesliwy);
    }
  };
    ...
    <Grid.Row stretched>
      <Grid.Column>
          <Segment textAlign='center'>
           ...
           <br/>
           <Slider value={ratingSzczesliwy} color="red" settings={settings} /> 
           </Segment>
          ...
          <br/>
          <Button className='button-580' size="large"   color='yellow'  role="button" loading={isLoading} disabled={isLoading1}  onClick={handleClick}>
