...
export default function SłabyBodziec(props) {
...
const handleSubmit = async (e) => {
    ...
    try {
      ...
      .then(() => {
        history.push("/DodajSłabyNotatki/"+path)
    ...
    <Grid.Row stretched>
      ...
      Wybierz przyczynę uczucia
        ...
        Wpisz własną (i wciśni Enter)
          ...
          <br/>
          <Button className='button-532' size="large" style={{marginTop:"65px"}}   color='teal'  role="button" loading={isLoading} disabled={isLoading1}  onClick={handleClick}>
