...
export default function SłabyBodziecwewnątrz(props) {
    ...
    <Grid.Row stretched>
      ...
      Wybierz przyczynę uczucia
        ...
        Wpisz własną (i wciśni Enter)
          ...
          <br/>
          <Button   color='teal' className='button-532' size="large" style={{marginTop:"65px"}}   role="button" loading={isLoading} disabled={isLoading1}  onClick={handleClick}>
