...
export default function SłabyNazwa(props) {
...
const buttonRef = createRef()
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      .then(() => {
        history.push("/DodajSłabyStan/"+path)
  ...
  <Qn1>Nazwa twojego uczucia to:</Qn1>
    <Grid.Row stretched>
      <Grid.Column>
          ...
          <Button animated className='button-532' size="large"   color='teal'  role="button" loading={isLoading} disabled={isLoading1}  onClick={handleClick}>
           {isLoading ? "" : "" }
