...
export default function SłabyRozkojarzony() {
  const [title, setTitle] = useState("Słaby");
  const [desc, setDesc] = useState("Rozkojarzony");
    ...
    <Grid.Row stretched>
      <Grid.Column>
          <Segment textAlign='center'>
           ...
           <AsyncCreatableSelect loadOptions={loadOptions} placeholder="Przyczyna. Wybierz z listy lub dodaj i wciśni Enter" 
