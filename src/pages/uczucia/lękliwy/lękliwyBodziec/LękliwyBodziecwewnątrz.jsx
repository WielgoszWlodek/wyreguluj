...
export default function LękliwyBodziecwewnątrz(props) {
    ...
    <Grid.Row stretched>
      ...
      Wybierz przyczynę uczucia
        ...
        Wpisz własną (i wciśni Enter)
          ...
          <br/>
          <Button   color='green' content='Green' style={{marginTop:"65px"}} className='button-56' size="large"   role="button" loading={isLoading} disabled={isLoading1}  onClick={handleClick}>
