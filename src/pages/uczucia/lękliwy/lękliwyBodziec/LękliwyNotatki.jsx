...
export default function LękliwyNotatki(props) {
    ...
    <Grid.Row stretched>
      <Grid.Column>
        ...
        />
          ...
          <br/>
          <Button className='button-56' size="large"   color='green'  role="button" loading={isLoading} disabled={isLoading1}  onClick={handleClick}>
