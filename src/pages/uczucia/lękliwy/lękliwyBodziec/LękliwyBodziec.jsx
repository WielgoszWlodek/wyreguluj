...
import { Label, Grid, Button, Form, TextArea, Dimmer, Loader, Image, Segment ,Icon, Divider } from "semantic-ui-react";
...
export default function LękliwyBodziec(props) {
...
const handleSubmit = async (e) => {
    ...
    try {
      ...
      .then(() => {
        history.push("/DodajLękliwyNotatki/"+path)
    ...
    <Grid.Row stretched>
      ...
      Wybierz przyczynę uczucia
        ...
        Wpisz własną (i wciśni Enter)
           ...
           <AsyncCreatableSelect style={{marginTop:"-250px"}} loadOptions={loadOptions} placeholder="Przyczyna uczucia..." 
          ...
          <br/>
          <Button className='button-56' size="large" style={{marginTop:"65px"}}  color='green'  role="button" loading={isLoading} disabled={isLoading1}  onClick={handleClick}>
