...
export default function RozgniewanyBodziec(props) {
...
const handleSubmit = async (e) => {
    ...
    try {
      ...
      .then(() => {
        history.push("/DodajRozgniewanyNotatki/"+path)
    ...
    <Grid.Row stretched>
      ...
      Wybierz przyczynę uczucia
        ...
        Wpisz własną (i wciśni Enter)
          ...
          <br/>
          <Button className='button-540' size="large" style={{marginTop:"65px"}}   color='red'  role="button" loading={isLoading} disabled={isLoading1}  onClick={handleClick}>
