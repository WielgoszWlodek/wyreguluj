...
export default function RozgniewanyBodziecwewnątrz(props) {
    ...
    <Grid.Row stretched>
      ...
      Wybierz przyczynę uczucia
        ...
        Wpisz własną (i wciśni Enter)
          ...
          <br/>
          <Button   color='red' className='button-540' size="large" style={{marginTop:"65px"}}   role="button" loading={isLoading} disabled={isLoading1}  onClick={handleClick}>
