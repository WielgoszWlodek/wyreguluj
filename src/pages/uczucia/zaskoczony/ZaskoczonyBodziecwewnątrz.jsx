...
export default function ZaskoczonyBodziecwewnątrz(props) {
    ...
    <Grid.Row stretched>
      ...
      Wybierz przyczynę uczucia
        ...
        Wpisz własną (i wciśni Enter)
          ...
          <br/>
          <Button   color='purple' className='button-593' size="large" style={{marginTop:"65px"}}   role="button" loading={isLoading} disabled={isLoading1}  onClick={handleClick}>
