...
export default function ZaskoczonyBodziec(props) {
...
const handleSubmit = async (e) => {
    ...
    try {
      ...
      .then(() => {
        history.push("/DodajZaskoczonyNotatki/"+path)
    ...
    <Grid.Row stretched>
      ...
      Wybierz przyczynę uczucia
        ...
        Wpisz własną (i wciśni Enter)
          ...
          <br/>
          <Button className='button-593' size="large" style={{marginTop:"65px"}}   color='purple'  role="button" loading={isLoading} disabled={isLoading1}  onClick={handleClick}>
