...
export default function ZaskoczonyNazwa(props) {
...
const buttonRef = createRef()
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      .then(() => {
        history.push("/DodajZaskoczonyStan/"+path)
    ...
    <Grid.Row stretched>
      <Grid.Column>
          <Segment  color='blue'  size='mini'>
           ...
           <Segment   color='violet'size='tiny'>
            <input
            type="text"
            value={Posredni}
           ...
           <Segment color='purple' size='small'>
            <input
            type="text"
            value={desc}
          ...
          <Button animated className='button-593' size="large"   color='purple'  role="button" loading={isLoading} disabled={isLoading1}  onClick={handleClick}>
           {isLoading ? "" : "" }
