...
export default function ZniesmaczonyBodziecwewnątrz(props) {
    ...
    <Grid.Row stretched>
      ...
      Wybierz przyczynę uczucia
        ...
        Wpisz własną (i wciśni Enter)
          ...
          <br/>
          <Button   color='grey' className='button-550' size="large" style={{marginTop:"65px"}}   role="button" loading={isLoading} disabled={isLoading1}  onClick={handleClick}>
