...
export default function ZniesmaczonyNazwa(props) {
...
const buttonRef = createRef()
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      .then(() => {
        history.push("/DodajZniesmaczonyStan/"+path)
  ...
  <Qn1>Nazwa twojego uczucia to:</Qn1>
    <Grid.Row stretched>
      <Grid.Column>
          ...
          <Button animated className='button-550' size="large"   color='grey'  role="button" loading={isLoading} disabled={isLoading1}  onClick={handleClick}>
           {isLoading ? "" : "" }
