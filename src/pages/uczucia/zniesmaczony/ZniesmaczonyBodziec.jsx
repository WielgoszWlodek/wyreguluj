...
export default function ZniesmaczonyBodziec(props) {
...
const handleSubmit = async (e) => {
    ...
    try {
      ...
      .then(() => {
        history.push("/DodajZniesmaczonyNotatki/"+path)
    ...
    <Grid.Row stretched>
      ...
      Wybierz przyczynę uczucia
        ...
        Wpisz własną (i wciśni Enter)
          ...
          <br/>
          <Button className='button-550' size="large" style={{marginTop:"65px"}}   color='grey'  role="button" loading={isLoading} disabled={isLoading1}  onClick={handleClick}>
