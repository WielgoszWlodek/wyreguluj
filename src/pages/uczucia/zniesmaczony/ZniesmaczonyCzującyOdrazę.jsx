...
export default function ZniesmaczonyCzującyOdrazę() {
  const [title, setTitle] = useState("Zniesmaczony");
  const [desc, setDesc] = useState("Czujący odrazę");
   ...
   <Grid >
    ...
    <Grid.Row stretched>
      <Grid.Column>
          ...
          <br/>
          <Button className='button-55' size="large"   color='grey'  role="button" loading={isLoading} disabled={isLoading1}  onClick={handleClick}>
