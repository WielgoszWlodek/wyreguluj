...
export default function SmutnyBodziecwewnątrz(props) {
    ...
    <Grid.Row stretched>
      ...
      Wybierz przyczynę uczucia
        ...
        Wpisz własną (i wciśni Enter)
          ...
          <br/>
          <Button style={{marginTop:"65px"}}   color='violet' className='button-57' size="large"   role="button" loading={isLoading} disabled={isLoading1}  onClick={handleClick}>
