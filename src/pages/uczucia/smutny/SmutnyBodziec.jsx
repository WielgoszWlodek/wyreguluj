...
export default function SmutnyBodziec(props) {
...
const handleSubmit = async (e) => {
    ...
    try {
      ...
      .then(() => {
        history.push("/DodajSmutnyNotatki/"+path)
    ...
    <Grid.Row stretched>
      ...
      Wybierz przyczynę uczucia
        ...
        Wpisz własną (i wciśni Enter)
          ...
          <br/>
          <Button className='button-57' size="large" style={{marginTop:"65px"}}   color='violet'  role="button" loading={isLoading} disabled={isLoading1}  onClick={handleClick}>
