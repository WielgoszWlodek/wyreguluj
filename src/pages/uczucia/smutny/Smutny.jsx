...
export default function Smutny() {
  ...
  const [ratingSmutny, setRatingSmutny] = useState(2);
...
const buttonRef = createRef()
  ...
  const settings = {
    ...
    max: 8,
    step: 1,
    onChange: ratingSmutny => {
      setRatingSmutny(ratingSmutny);
    }
  };
    ...
    <Grid.Row stretched>
      <Grid.Column>
          <Segment textAlign='center'>
           ...
           <br/>
           <Slider value={ratingSmutny} color="red" settings={settings} /> 
           </Segment>
