...
export default function SmutnyNazwa(props) {
...
const buttonRef = createRef()
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      .then(() => {
        history.push("/DodajSmutnyStan/"+path)
    ...
    <Grid.Row stretched>
      <Grid.Column>
          <Segment  color='teal'  size='mini'>
           ...
           <Segment color='violet' size='small'>
            <input
            type="text"
            value={desc}
          ...
          <Button animated className='button-57' size="large"   color='violet'  role="button" loading={isLoading} disabled={isLoading1}  onClick={handleClick}>
           {isLoading ? "" : "" }
