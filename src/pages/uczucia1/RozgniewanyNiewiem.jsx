...
export default function RozgniewanyNiewiem() {
  ...
  const [ratingRozgniewany1, setRatingRozgniewany1] = useState(2);
...
const buttonRef = createRef()
  ...
  const settings = {
    ...
    max: 8,
    step: 1,
    onChange: ratingRozgniewany1 => {
      setRatingRozgniewany1(ratingRozgniewany1);
    }
  };
  ...
  <Qn2>Natężenie uczucia po regulacji</Qn2>
    <Grid.Column>
        <Segment textAlign='center'>
         ...
         <br/>
         <Slider value={ratingRozgniewany1} color="red" settings={settings} /> 
         </Segment>
        ...
        <br/>
        <Button className='button-540' size="large"   color='red'  role="button" loading={isLoading} disabled={isLoading1}  onClick={handleClick}>
