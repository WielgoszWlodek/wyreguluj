...
export default function LękliwyNiewiem() {
  ...
  const [ratingLekliwy1, setRatingLekliwy1] = useState(2);
...
const buttonRef = createRef()
  ...
  const settings = {
    ...
    max: 8,
    step: 1,
    onChange: ratingLekliwy1 => {
      setRatingLekliwy1(ratingLekliwy1);
    }
  };
  ...
  <Qn2>Natężenie uczucia po regulacji</Qn2>
    <Grid.Column>
        <Segment textAlign='center'>
         ...
         <br/>
         <Slider value={ratingLekliwy1} color="red" settings={settings} /> 
         </Segment>
        ...
        <br/>
        <Button className='button-560' size="large"   color='green'  role="button" loading={isLoading} disabled={isLoading1}  onClick={handleClick}>
