...
export default function SzczęśliwyNiewiem() {
  ...
  const [ratingSzczesliwy1, setRatingSzczesliwy1] = useState(2);
...
const buttonRef = createRef()
  ...
  const settings = {
    ...
    max: 8,
    step: 1,
    onChange: ratingSzczesliwy1 => {
      setRatingSzczesliwy1(ratingSzczesliwy1);
    }
  };
  ...
  <Grid.Row stretched>
    ...
    <Grid.Column>
        <Segment textAlign='center'>
         ...
         <br/>
         <Slider value={ratingSzczesliwy1} color="red" settings={settings} /> 
         </Segment>
