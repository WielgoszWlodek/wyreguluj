...
export default function SmutnyNiewiem() {
  ...
  const [ratingSmutny1, setRatingSmutny1] = useState(2);
...
const buttonRef = createRef()
  ...
  const settings = {
    ...
    max: 8,
    step: 1,
    onChange: ratingSmutny1 => {
      setRatingSmutny1(ratingSmutny1);
    }
  };
  ...
  <Qn2>Natężenie uczucia po regulacji</Qn2>
    <Grid.Column>
        <Segment textAlign='center'>
         ...
         <br/>
         <Slider value={ratingSmutny1} color="red" settings={settings} /> 
         </Segment>
