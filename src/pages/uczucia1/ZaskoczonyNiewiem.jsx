...
export default function ZaskoczonyNiewiem() {
  ...
  const [ratingZaskoczony1, setRatingZaskoczony1] = useState(2);
...
const buttonRef = createRef()
  ...
  const settings = {
    ...
    max: 8,
    step: 1,
    onChange: ratingZaskoczony1 => {
      setRatingZaskoczony1(ratingZaskoczony1);
    }
  };
  ...
  <Qn2>Natężenie uczucia po regulacji</Qn2>
    <Grid.Column>
        <Segment textAlign='center'>
         ...
         <br/>
         <Slider value={ratingZaskoczony1} color="red" settings={settings} /> 
         </Segment>
