...
export default function ZniesmaczonyNiewiem() {
  ...
  const [ratingZniesmaczony1, setRatingZniesmaczony1] = useState(2);
...
const buttonRef = createRef()
  ...
  const settings = {
    ...
    max: 8,
    step: 1,
    onChange: ratingZniesmaczony1 => {
      setRatingZniesmaczony1(ratingZniesmaczony1);
    }
  };
  ...
  <Qn2>Natężenie uczucia po regulacji</Qn2>
    <Grid.Column>
        <Segment textAlign='center'>
         ...
         <br/>
         <Slider value={ratingZniesmaczony1} color="red" settings={settings} /> 
         </Segment>
